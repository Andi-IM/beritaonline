            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td> <a href="<?= $adminurl; ?>index.php?p=hapus-artikel&id=<?= $row['id_konten']; ?>" class="btn btn-danger"><span class="glyphicon
glyphicon-trash"></span></a> <a href="<?= $adminurl; ?>index.php?p=edit-artikel&id=<?= $row['id_konten']; ?>
