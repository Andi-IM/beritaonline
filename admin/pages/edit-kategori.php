...
if (isset($_POST['submit'])) {
    ...
    if (!empty($kategori)) {
        if (updateKategori($id, $kategori)) {
            echo
                '<script>window.location="' . $adminurl . 'index.php?p=data-kategori"</script>';
        } else {
...
<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <form class="form-horizontal" action="" method="post">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="kategori" id="kategori" value="<?= $gk_nm_kategori; ?>" placeholder="Masukan nama
    kategori...">
            </div>
            <div class="checkbox">
                <p><?= $error; ?></p>
    ...
    btn-default">Update Kategori</button>
            </div>
        </form>
    </div>
</div>