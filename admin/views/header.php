            ...
            <ul class="nav navbar-right navbar-top-links">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?= $adminurl; ?>"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-sitemap fa-fw"></i>Artikel<span class="fa arrow"></span>
                            </a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-tag fa-fw"></i>
                                Kategori<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li><a href="<?= $adminurl; ?>index.php?p=logout" class="active"><i class="fa fa-sign-out fa-fw"></i> Logout </a>
                        </li>
